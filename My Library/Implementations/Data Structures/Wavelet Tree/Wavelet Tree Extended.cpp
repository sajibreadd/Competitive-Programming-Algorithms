...
// Sum query will not work then. The code will have to be update to make the sum query work
// Replacing the "*it" values by actual values will solve it.
// sum query is not tested

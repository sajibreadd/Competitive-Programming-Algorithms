/***
    * mat is 0 based
    * n rows(equations) and m columns(variables)
    * ans[i] = solution for the i'th variable (0 based)
    * where[i] = the row index of the pivot element of column i
    * call to GaussJordan() returns the (number of solutions % MOD)
    ...
    * Complexity --> O( min(n,m) * nm )/64 because of using bitset
**/
